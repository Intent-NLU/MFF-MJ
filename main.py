...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", default='MixATIS_clean', required=True, type=str, help="The name of the task to train")
    parser.add_argument("--model_dir", default='MixATIS_clean_model', required=True, type=str, help="Path to save, load model")
    parser.add_argument("--order_type",default=True,help="muti_intent_order is true or single_intent_order false")
    parser.add_argument("--alpha", default=0.2, type=float, help="Dropout for fully-connected layers")

    parser.add_argument("--data_dir", default="./data", type=str, help="The input data dir")
    parser.add_argument("--intent_label_file", default="intent_label.txt", type=str, help="Intent Label file")
    parser.add_argument("--slot_label_file", default="slot_label.txt", type=str, help="Slot Label file")
    parser.add_argument("--threshold", default=0.4,  type=float, help="The name of the task to train")
    ...
    parser.add_argument("--only_eval",default=True, action="store_true", help="Whether only to run eval on the test set.")
