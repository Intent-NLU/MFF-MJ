...
if __name__ == '__main__':
    ...
    parser.add_argument("--task", default='MixATIS_clean', required=True, type=str,
                        help="The name of the task to train")
    parser.add_argument("--model_dir", default='MixATIS_clean_model', required=True, type=str,
    ...
    parser.add_argument("--only_eval", default=True, action="store_true",
                        help="Whether only to run eval on the test set.")
